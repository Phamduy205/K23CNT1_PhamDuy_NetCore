...
{
    public class PvdPublishersController : Controller
    {
        private readonly PvdBookStoreContext _context;

        public PvdPublishersController(PvdBookStoreContext context)
        {
            _context = context;
        }
        ...
        // GET: PvdPublishers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PvdPublishers/Create
